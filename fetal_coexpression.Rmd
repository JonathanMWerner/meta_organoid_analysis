...
test$goterms = rep(c(as.character(go_terms), 'gaba_markers','glut_markers','nonN_markers','nProg_markers','intProg_markers','divProg_markers'), length(dataset_names))
...
#save(fetal_agg_rank_mat , file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_fetal_coexp_network_just_go.Rdata')
#save(fetal_agg_rank_mat , file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_fetal_coexp_network_just_go_v2.Rdata')
#save(fetal_agg_rank_mat , file = '../data/coexpression/fetal/agg_fetal_coexp_network_10_12_22.Rdata')
#save(fetal_agg_rank_mat , file = '../data/coexpression/fetal/agg_fetal_coexp_network_1_16_23.Rdata')
...
#Exclude the dividing markers from the intMarker set
...
```{r}
#save(fetal_agg_network_egad_results, file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_fetal_egad_results.Rdata')

#save(fetal_agg_network_egad_results, file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_fetal_egad_results_med_impute.Rdata')

#save(fetal_agg_network_egad_results, file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_fetal_egad_results_just_go.Rdata')
#save(fetal_agg_network_egad_results, file = '../data/coexpression/fetal/agg_fetal_egad_results_10_12_22.Rdata')
#save(fetal_agg_network_egad_results, file = '../data/coexpression/fetal/agg_fetal_egad_results_1_16_23.Rdata')
save(fetal_agg_network_egad_results, file = '../data/coexpression/fetal/agg_fetal_egad_results_8_17_23.Rdata')
```
...
fetal_agg_network_egad_results[c('gaba_markers','glut_markers','nonN_markers','nProg_markers', 'intProg_markers', 'divProg_markers'), ]
```
...
temp_agg_rank_mat = fetal_agg_rank_mat[rownames(fetal_agg_rank_mat) %in% all_marker_genes, colnames(fetal_agg_rank_mat) %in% all_marker_genes ]
...
test = do.call(rbind, all_dataset_egad)
test = as.data.frame(test)
test$goterms = rep(c(as.character(go_terms), 'gaba_markers','glut_markers','nonN_markers','nProg_markers', 'intProg_markers','divProg_markers'), length(ranked_coexp_paths_just_go))
test = reshape2::melt(test, id = c('goterms', 'dataset'))
test$value = as.numeric(test$value)
table(test$dataset)
test
...
#save(unannot_fetal_egad_results, file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/unannot_fetal_egad_results_just_go_ranked.Rdata')
#save(unannot_fetal_egad_results, file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/unannot_fetal_egad_results_just_go_ranked_v2.Rdata')
#save(unannot_fetal_egad_results, file = '../data/coexpression/fetal/unannot_fetal_egad_results_ranked_10_12_22.Rdata')
#save(unannot_fetal_egad_results, file = '../data/coexpression/fetal/unannot_fetal_egad_results_ranked_1_16_23.Rdata')
save(unannot_fetal_egad_results, file = '../data/coexpression/fetal/unannot_fetal_egad_results_ranked_8_17_23.Rdata')
```
...
#save(unannot_fetal_agg_rank_mat , file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_unannot_fetal_coexp_network_just_go.Rdata')
#save(unannot_fetal_agg_rank_mat , file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_unannot_fetal_coexp_network_just_go_v2.Rdata')
#save(unannot_fetal_agg_rank_mat , file = '../data/coexpression/fetal/agg_unannot_fetal_coexp_network_10_12_22.Rdata')
#save(unannot_fetal_agg_rank_mat , file = '../data/coexpression/fetal/agg_unannot_fetal_coexp_network_1_16_23.Rdata')
save(unannot_fetal_agg_rank_mat , file = '../data/coexpression/fetal/agg_unannot_fetal_coexp_network_8_17_23.Rdata')
```


```{r}
#load(file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_unannot_fetal_coexp_network_med_impute.Rdata')
...
#save(unannot_fetal_agg_network_egad_results, file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_unannot_fetal_egad_results_just_go.Rdata')
#save(unannot_fetal_agg_network_egad_results, file = '/home/werner/projects/meta_qc_organoid/data/coexpression/fetal/agg_unannot_fetal_egad_results_just_go_v2.Rdata')
#save(unannot_fetal_agg_network_egad_results, file = '../data/coexpression/fetal/agg_unannot_fetal_egad_results_10_12_22.Rdata')
#save(unannot_fetal_agg_network_egad_results, file = '../data/coexpression/fetal/agg_unannot_fetal_egad_results_1_16_23.Rdata')
save(unannot_fetal_agg_network_egad_results, file = '../data/coexpression/fetal/agg_unannot_fetal_egad_results_8_17_23.Rdata')
```
...
unannot_fetal_agg_network_egad_results[22933:22940, ]
