...
all_sample_meta
```
Arlotta dataset is the 1-26 organoid datasets, uzquiano datasets
Use the sample_ids as the dataset name

```{r}
org_dataset_paths = all_sample_meta$processed_seurat_path[grepl('uzquiano', all_sample_meta$sample_ids)]
org_dataset_names = all_sample_meta$sample_ids[grepl('uzquiano', all_sample_meta$sample_ids)]
names(org_dataset_paths) =org_dataset_names 
...
nProg_time_df  = reshape2::melt(t(nProg_time_df), varnames = c('Fetal_timepoint','Organoid_dataset'), value.name = 'AUC')
...
divProg_time_df  = reshape2::melt(t(divProg_time_df), varnames = c('Fetal_timepoint','Organoid_dataset'), value.name = 'AUC')
...
intProg_time_df  = reshape2::melt(t(intProg_time_df), varnames = c('Fetal_timepoint','Organoid_dataset'), value.name = 'AUC')
...
glut_time_df  = reshape2::melt(t(glut_time_df), varnames = c('Fetal_timepoint','Organoid_dataset'), value.name = 'AUC')
...
gaba_time_df  = reshape2::melt(t(gaba_time_df), varnames = c('Fetal_timepoint','Organoid_dataset'), value.name = 'AUC')
...
nonN_time_df  = reshape2::melt(t(nonN_time_df), varnames = c('Fetal_timepoint','Organoid_dataset'), value.name = 'AUC')
...
ggsave(filename = 'organoid_nProg_celltype_AUC_timeseries_with_firstTri_fetal_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
ggsave(filename = 'organoid_divProg_celltype_AUC_timeseries_with_firstTri_fetal_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
ggsave(filename = 'organoid_glut_celltype_AUC_timeseries_with_firstTri_fetal_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
      height = 4, width = 10)
...
ggsave(filename = 'organoid_gaba_celltype_AUC_timeseries_with_firstTri_fetal_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
ggsave(filename = 'organoid_nonN_celltype_AUC_timeseries_with_firstTri_fetal_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
ggsave(filename = 'organoid_intProg_celltype_AUC_timeseries_with_firstTri_fetal_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
save(divProg_time_df, nProg_time_df, intProg_time_df, gaba_time_df, glut_time_df, nonN_time_df, 
     file = '../data/coexpression/org_timeseries_celltypeAUROC_dataframes_v2.Rdata')
...
load('../data/coexpression/org_timeseries_celltypeAUROC_dataframes_v2.Rdata')
```
...
```{r}
divProg_time_df %>% group_by(Organoid_timepoint) %>% summarize(time_diff = AUC[Fetal_timepoint == 'GW5'] - AUC[Fetal_timepoint == 'GW25']) %>% ungroup() %>%
  summarize(mean = abs(mean(time_diff)), sd = sd(time_diff))
nProg_time_df %>% group_by(Organoid_timepoint) %>% summarize(time_diff = AUC[Fetal_timepoint == 'GW5'] - AUC[Fetal_timepoint == 'GW25']) %>% ungroup() %>%
  summarize(mean = abs(mean(time_diff)), sd = sd(time_diff))

glut_time_df %>% group_by(Organoid_timepoint) %>% summarize(time_diff = AUC[Fetal_timepoint == 'GW5'] - AUC[Fetal_timepoint == 'GW25']) %>% ungroup() %>%
  summarize(mean = abs(mean(time_diff, na.rm = T)), sd = sd(time_diff, na.rm = T))
gaba_time_df %>% group_by(Organoid_timepoint) %>% summarize(time_diff = AUC[Fetal_timepoint == 'GW5'] - AUC[Fetal_timepoint == 'GW25']) %>% ungroup() %>%
  summarize(mean = abs(mean(time_diff, na.rm = T)), sd = sd(time_diff, na.rm = T))
nonN_time_df %>% group_by(Organoid_timepoint) %>% summarize(time_diff = AUC[Fetal_timepoint == 'GW5'] - AUC[Fetal_timepoint == 'GW25']) %>% ungroup() %>%
  summarize(mean = abs(mean(time_diff, na.rm = T)), sd = sd(time_diff, na.rm = T))
...
Get the mean score across all cell-types for the MetaMarkers and individual datasets
```{r}

glut_time_df$cell_type = rep('Glutamatergic', length = nrow(glut_time_df))
gaba_time_df$cell_type = rep('GABAergic', length = nrow(gaba_time_df))
nonN_time_df$cell_type = rep('Non-neuronal', length = nrow(nonN_time_df))
nProg_time_df$cell_type = rep('Neural_Progenitor', length = nrow(nProg_time_df))
intProg_time_df$cell_type = rep('Intermediate_Progenitor', length = nrow(intProg_time_df))
divProg_time_df$cell_type = rep('Dividing_Progenitor', length = nrow(divProg_time_df))


all_time_df = do.call(rbind, list(glut_time_df, gaba_time_df, nonN_time_df, nProg_time_df, intProg_time_df, divProg_time_df))
all_time_df %>% group_by(Fetal_timepoint) %>% summarize(mean_scores = mean(AUC, na.rm = T), sd_scores = sd(AUC, na.rm = T)) %>% arrange(desc(mean_scores))
...
for(j in 1:length(org_dataset_names)){
  ...
  start = Sys.time()
  corr_path = sprintf('../data/coexpression/organoid/6_26_24_GO_coexp/ranked_%s_coexp.Rdata', org_dataset_names[j])
  x = load(corr_path)
...
save(org_nProg_time_cons_coexp_matrix, file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_nProg_v4.Rdata')
save(org_divProg_time_cons_coexp_matrix, file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_divProg_v4.Rdata')
save(org_intProg_time_cons_coexp_matrix, file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_intProg_v4.Rdata')
save(org_gaba_time_cons_coexp_matrix, file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_gaba_v4.Rdata')
save(org_glut_time_cons_coexp_matrix, file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_glut_v4.Rdata')
save(org_nonN_time_cons_coexp_matrix, file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_nonN_v4.Rdata')
...
load( file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_nProg_v4.Rdata')
load( file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_divProg_v4.Rdata')
load( file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_intProg_v4.Rdata')
load( file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_gaba_v4.Rdata')
load( file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_glut_v4.Rdata')
load( file = '../data/coexpression/org_timeseries_consCoexp_results_df_with_1st_trimester_nonN_v4.Rdata')
...
ggsave(filename = 'organoid_nProg_consCoexp_AUC_timeseries_with_1st_tri_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
ggsave(filename = 'organoid_divProg_consCoexp_AUC_timeseries_with_1st_tri_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
ggsave(filename = 'organoid_intProg_consCoexp_AUC_timeseries_with_1st_tri_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
ggsave(filename = 'organoid_glut_consCoexp_AUC_timeseries_with_1st_tri_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
ggsave(filename = 'organoid_gaba_consCoexp_AUC_timeseries_with_1st_tri_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
...
ggsave(filename = 'organoid_nonN_consCoexp_AUC_timeseries_with_1st_tri_v4.pdf', path = 'graphs/organoid_timeseries/', device = 'pdf', useDingbats = F,
       height = 4, width = 10)
